        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    {!! Form::model($service,['route'=>['service.update',$service->id],'method'=>'PUT','class'=>'form-horizontal','files'=>'true']) !!}
                                ...
                                @foreach(config('translatable.locales') as $count => $langs )
                                    <div class="tab-pane @if($count == 0) active @endif p-3" id="title{{$langs}}" role="tabpanel">
                                        <p class="font-14 mb-0">
                                            <input class="form-control" type="text" value="{{$service->translate($langs)->title}}"  name="title[{{$langs}}]" required>
                                        </p>
                                    </div>
                                @endforeach
                            </div>
                                    ...
                                    <div class="tab-pane @if($count == 0) active @endif p-3" id="content{{$langs}}" role="tabpanel">
                                        <p class="font-14 mb-0">
                                            <textarea class="form-control" type="text"  name="content[{{$langs}}]" required>
                                                {{$service->translate($langs)->content}}
                                            </textarea>
                                        </p>
                                    </div>
                                @endforeach
                    ...
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Hizmet Görseli</label>
                        <div class="col-sm-10">
                            <div class="control-group">
                                ...
                                <img src="/{{$service->image}}" width="150px">
                            </div>
                            <br/>
